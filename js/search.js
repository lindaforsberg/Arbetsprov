...
(function () {
    ...
    $(function () {
        ...
        function storeSearchResult() {
            ...
            $('#SearchResultsList').append("<li class='search-item clearfix'><span class='title'>" + result.title + "</span><time>" + result.time + "</time><div class='remove' id='remove'><span>x</span></div></li> ");
            searchInput.val("")
        };
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (!data) return;
                        //var volumeInfo = data['items'].map(function (item) { return item["volumeInfo"]; });
                        //var title = volumeInfo.map(function (item) { return item["title"]; });
